...
#+begin_src lisp
((T NIL)
 (#<PASS #'rt-test731> #<PASS #'readtables-test732> #<PASS #'sym-test733>
  #<PASS #'str-test734> #<PASS #'list-test735> #<PASS #'log-test736>
  #<PASS #'cond-test737> #<PASS #'reexport-test738> #<PASS #'thread-test739>
  #<PASS #'alien-test740> #<PASS #'fmt-test741> #<PASS #'fu-test742>
  #<PASS #'ana-test743> #<PASS #'pan-test744> #<PASS #'cli-test750>))
#+end_src
