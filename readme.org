...
Or interactively:
#+begin_src lisp :results output :wrap src lisp :exports both
  (ql:quickload :macs)
  (ql:quickload :macs/rt)
  (ql:quickload :macs/tests)
  ...
  (load "tests.lisp")
  (list (multiple-value-list (macs.rt:do-tests :macs)) (test-results macs.rt:*test-suite*))
#+end_src
...
:DEBUG @ 818.95667 :: running test:  CLI #<PASS CLI-TEST845> 
:DEBUG @ 818.95667 :: running test:  PAN #<PASS PAN-TEST839> 
:DEBUG @ 818.95667 :: running test:  ANA #<PASS ANA-TEST838> 
:DEBUG @ 818.95667 :: running test:  FU #<PASS FU-TEST837> 
:DEBUG @ 818.95667 :: running test:  FMT #<PASS FMT-TEST836> 
:DEBUG @ 818.95667 :: running test:  ALIEN #<PASS ALIEN-TEST835> 
:DEBUG @ 818.96 :: running test:  THREAD #<PASS THREAD-TEST834> 
:DEBUG @ 818.96 :: running test:  REEXPORT #<PASS REEXPORT-TEST833> 
:DEBUG @ 818.96 :: running test:  COND #<PASS COND-TEST832> 
:DEBUG @ 818.96 :: running test:  LOG #<PASS LOG-TEST831> 
:DEBUG @ 818.96 :: running test:  LIST #<PASS LIST-TEST830> 
:DEBUG @ 818.96 :: running test:  STR #<PASS STR-TEST829> 
:DEBUG @ 818.96 :: running test:  SYM #<PASS SYM-TEST828> 
:DEBUG @ 818.96 :: running test:  READTABLES #<PASS READTABLES-TEST827> 
:DEBUG @ 818.96 :: running test:  RT #<PASS RT-TEST826> 
No tests failed.
#+end_src
