...
#+RESULTS:
#+begin_src lisp
; compiling file "/home/ellis/dev/macs/tests.lisp" (written 30 SEP 2023 05:23:59 PM):
...
#<CLI macs.tests :opts 2 :cmds 1> 0.1.0
...
#<PASS FMT-TEST1340> 
#<PASS ALIEN-TEST1339> 
Current thread: #<THREAD tid=1926308 "worker" RUNNING {1004E42D33}>

Current thread name: worker

All threads:
 #<THREAD tid=1920339 "main thread" RUNNING {1000000113}>
#<THREAD tid=1923884 "worker" RUNNING {10073C8B43}>
#<THREAD tid=1920360 "reader-thread" RUNNING {1002C30DF3}>
#<THREAD tid=1920366 "auto-flush-thread" RUNNING {1005BD0133}>
#<THREAD tid=1920361 "swank-indentation-cache-thread" RUNNING {1002C30FC3}>
#<THREAD tid=1920359 "control-thread" RUNNING {1002C21203}>
#<THREAD tid=1923891 "worker" RUNNING {10073C9383}>
#<THREAD tid=1926308 "worker" RUNNING {1004E42D33}>
#<THREAD tid=1923914 "worker" RUNNING {10073CD1E3}>
#<THREAD tid=1923897 "worker" RUNNING {10073CBEA3}>
#<THREAD tid=1920367 "repl-thread" RUNNING {1005BD11B3}>

#<PASS THREAD-TEST1338> 
#<PASS REEXPORT-TEST1337> 
#<PASS COND-TEST1336> 
:DEBUG @ 1029.66 :: test DEBUG 
#<PASS LOG-TEST1335> 
#<PASS LIST-TEST1334> 
#<PASS STR-TEST1333> 
#<PASS SYM-TEST1332> 
#<PASS READTABLES-TEST1331> 
#<PASS RT-TEST1330> 
No tests failed.
#+end_src
