...
#+begin_src lisp
in suite MACS with 14/14 tests:
:DEBUG @ 6314.94    ; running test: 
; #<TEST CLI :fn CLI-test3399 :args NIL :persist NIL {1004DF7EC3}>

#<PASS CLI> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST PAN :fn PAN-test3398 :args NIL :persist NIL {1004BF5C53}>

#<PASS PAN> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST ANA :fn ANA-test3397 :args NIL :persist NIL {1004BF3713}>

#<PASS ANA> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST FMT :fn FMT-test3396 :args NIL :persist NIL {1004BF1F13}>

#<PASS FMT> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST ALIEN :fn ALIEN-test3395 :args NIL :persist NIL {1004AEFFE3}>

#<PASS ALIEN> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST THREAD :fn THREAD-test3394 :args NIL :persist NIL {1004AEE7E3}>

#<PASS THREAD> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST REEXPORT :fn REEXPORT-test3393 :args NIL :persist NIL {1004AED333}>

#<PASS REEXPORT> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST COND :fn COND-test3392 :args NIL :persist NIL {1004AEC083}>

#<PASS COND> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST LOG :fn LOG-test3391 :args NIL :persist NIL {1004AEADA3}>

#<PASS LOG> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST LIST :fn LIST-test3390 :args NIL :persist NIL {1004AE9963}>

#<PASS LIST> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST STR :fn STR-test3389 :args NIL :persist NIL {1004A6F993}>

#<PASS STR> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST SYM :fn SYM-test3388 :args NIL :persist NIL {1004A6DE83}>

#<PASS SYM> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST READTABLES :fn READTABLES-test3387 :args NIL :persist NIL {1004A6BED3}>

#<PASS READTABLES> 
:DEBUG @ 6314.94    ; running test: 
; #<TEST RT :fn RT-test3386 :args NIL :persist NIL {1004A69FB3}>
